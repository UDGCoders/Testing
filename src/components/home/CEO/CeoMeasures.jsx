            ...
            <div className="row g-5">
                <div className="col-sm-6">
                    ...
                    <div className="row border-bottom mt-5">
                        <div className="col-sm-6 border-end p-3">
                            <Counter title="YEARS OF GROWTH" targetNumber={10} prefix="+"/>
                        </div>
                        <div className="col-sm-6 p-3">
                            <Counter title="YEARS OF GROWTH" targetNumber={5}/>
                        </div>
                    </div>
                ...
                <div className="col-sm-6">
                    <img src="wp-content/uploads/2026/01/Frame-2608359.webp" alt="ceo picture" className='img-fluid' loading='lazy' />
